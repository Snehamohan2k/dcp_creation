const AssetMapCreation = (fileData, directoryName, directoryuuid) => {
  ...
  AnnotationNode.textContent = "Assets of " + directoryName;
  ...
  for (let i = 0; i < fileData.length; i++) {
    ...
    if (fileName === `${directoryName}.pkl.xml`) {
      const pklnode = xml.createElement("PackingList");
      pklnode.textContent = "true";
      AssetNode.appendChild(pklnode)
    }
...
export default AssetMapCreation;
